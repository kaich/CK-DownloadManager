#
#  Be sure to run `pod spec lint CKDownloadManager.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "kai cheng "
  # s.authors            = { "kai cheng " => "chengkai1853@163.com" }
  # s.social_media_url   = "http://twitter.com/kai cheng "
